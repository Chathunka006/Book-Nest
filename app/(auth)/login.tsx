        ...
        <View style={{
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            <View style={{
              ...
              borderWidth: 1,
              borderColor: emailError ? '#fca5a5' : '#fdba74',
              borderRadius: 12,
              ...
              <Ionicons 
                name="mail-outline" 
                size={20} 
                color={emailError ? "#ef4444" : "#f97316"} 
              />
              <TextInput
                style={{
                  flex: 1,
          ...
          <View style={{ marginBottom: 24 }}>
            ...
            <View style={{
              ...
              borderWidth: 1,
              borderColor: passwordError ? '#fca5a5' : '#fdba74',
              borderRadius: 12,
              paddingHorizontal: 16,
              paddingVertical: 16,
              minHeight: 52
              ...
              <Ionicons 
                ...
                size={20} 
                color={passwordError ? "#ef4444" : "#f97316"} 
              />
              <TextInput
                style={{
                  flex: 1,
          ...
          <View style={{
            ...
            <View style={{ flex: 1, height: 1, backgroundColor: '#fdba74' }} />
            <Text style={{
              marginHorizontal: 16,
              color: '#f97316',
              fontSize: 14,
